...
func (s *Server) Start() {
	...
	var loginLimit fiber.Handler = passthrough
	var registrationLimit fiber.Handler = passthrough
	var recoveryLimit fiber.Handler = passthrough
	var verificationLimit fiber.Handler = passthrough
