...
Создавать и активировать семестры может только администратор. Для дат используется формат RFC3339, например `2026-09-01T00:00:00+07:00`. В CORS добавлен метод `PATCH`, чтобы переключение работало из браузерного клиента.
