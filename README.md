...
- миграции создают тестовые профили; вход в них разрешается только при `ALLOW_DEMO_ACCOUNTS=true` на изолированном стенде. Исторические пароли нужно заменить до показа:
  - `teacher_test` / `123456`
  - `student_test` / `123456`
